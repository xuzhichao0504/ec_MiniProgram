...
Page({
  ...
  onLoad: function (options) {
    ...
    if (id) {
      ...
      wx.request({
        url: 'https://xuzhichao.cn/addr_get.do?id=' + id,
        // data: {},
  ...
  saveAddr: function (e) {
    ...
    wx.request({
      url: 'https://xuzhichao.cn/addr_saveOrUpdate',
      data: addr, isDefault: false, isLast: false,
  ...
  delAddr: function (e) {
    ...
    wx.request({
      url: 'https://xuzhichao.cn/addr_del.do?id=' + id,
      // data: {},
      method: 'GET', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT
      // header: {}, // 设置请求的 header
      success: function (res) {
